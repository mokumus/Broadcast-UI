...
export default function UpdateProfile(){
 ...
 function handleSubmit(e) {
        ...
        if(emailRef.current.email !== currentUser.email){
    ...
    return (
        <div>
            <Card>
                <Card.Body>
                    <h2 className="text-center mb-4">Update Profile OTP</h2>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button disabled={loading} class="w-100" type="submit">Update</Button>
                    </Form>
                </Card.Body>
            </Card>
